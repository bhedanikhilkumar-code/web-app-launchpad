...
![GitHub repo](https://img.shields.io/badge/GitHub-web-app-launchpad-0F172A?style=for-the-badge&logo=github)
...
| Repository topics | `css`, `github-pages`, `html`, `javascript`, `starter`, `webapp` |
| Useful commands | Documented in setup section |
| Key dependencies | No dependency manifest detected |

## Topics

`css` · `github-pages` · `html` · `javascript` · `starter` · `webapp`
